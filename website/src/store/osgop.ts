...
export const useOsgopStore = defineStore("osgop", {
  state: (): OsgopState => ({
    data: null,
    saving: false,
    saveError: null,
  ...
  actions: {
    ...
    async fetch(id: string) {
      ...
      try {
        const { data } = await rest.fetchEntity<Osgop>(Osgop.NAME, id, {
          view: "osgop-view",
        });
