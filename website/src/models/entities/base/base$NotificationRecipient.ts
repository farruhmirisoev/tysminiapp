...
export type NotificationRecipientView<V extends NotificationRecipientViewName> =
  V extends "_base"
    ? Pick<NotificationRecipient, "id" | "sqlQuery" | "legacyId" | "fundId">
    : V extends "_local"
    ? Pick<NotificationRecipient, "id" | "sqlQuery" | "legacyId" | "fundId">
    : V extends "_minimal"
    ...
    ? Pick<
        ...
        "id" | "sqlQuery" | "legacyId" | "fundId" | "template" | "user"
      >
    : never;
