...
export type DispatchMessageView<V extends DispatchMessageViewName> =
  V extends "_base"
    ? Pick<DispatchMessage, "id" | "dispatch" | "code" | "legacyId" | "fundId">
    : V extends "_local"
    ? Pick<DispatchMessage, "id" | "code" | "legacyId" | "fundId">
    : V extends "_minimal"
