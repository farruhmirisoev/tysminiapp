...
export class DicContactInfoType extends AbstractDictionary {
...
export type DicContactInfoTypeView<V extends DicContactInfoTypeViewName> =
  V extends "_base"
    ? Pick<
        DicContactInfoType,
        | "id"
    ...
    ? Pick<
      ...
      >
    : V extends "_minimal"
    ? Pick<DicContactInfoType, "id" | "langValue">
    : never;
