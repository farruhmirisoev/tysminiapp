<template>
  <section aria-label="Pricing" class="py-20 bg-slate-900 sm:py-32">
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      ...
      <div
        class="max-w-2xl mt-16 -mx-4 grid grid-cols-1 gap-y-10 sm:mx-auto lg:-mx-8 lg:max-w-none lg:grid-cols-3 xl:mx-0 xl:gap-x-8"
      >
        <section class="flex flex-col px-6 rounded-3xl sm:px-8 lg:py-8">
          ...
          <ul
            role="list"
            class="flex flex-col order-last mt-10 text-sm gap-y-3 text-slate-200"
          >
            <li class="flex">
              <svg
                aria-hidden="true"
          ...
          <a
            class="inline-flex items-center justify-center px-4 py-2 mt-8 text-sm text-white rounded-full group ring-1 focus:outline-none ring-slate-700 hover:ring-slate-500 active:ring-slate-700 active:text-slate-400 focus-visible:outline-white"
        ...
        <section
          class="flex flex-col order-first px-6 py-8 bg-primary rounded-3xl sm:px-8 lg:order-none"
        >
          ...
          <a
            class="inline-flex items-center justify-center px-4 py-2 mt-8 text-sm font-semibold bg-white rounded-full group focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 text-slate-900 hover:bg-blue-50 active:bg-blue-200 active:text-slate-600 focus-visible:outline-white"
