<template>
  <section
    ...
    class="py-20 bg-slate-50 sm:py-32"
  >
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      ...
      <ul
        role="list"
        class="max-w-2xl mx-auto mt-16 grid grid-cols-1 gap-6 sm:gap-8 lg:mt-20 lg:max-w-none lg:grid-cols-3"
      >
        <li>
          <ul role="list" class="flex flex-col gap-y-6 sm:gap-y-8">
            <li>
              <figure
                class="relative p-6 bg-white shadow-xl rounded-2xl shadow-slate-900/10"
              >
                <svg
                  aria-hidden="true"
                  width="105"
                ...
                >
                  <div>
                    <div class="text-base font-display text-slate-900">
                      Sheryl Berge
                    </div>
                  ...
                  <div class="overflow-hidden rounded-full bg-slate-50">
                    <img
                      alt=""
                      srcset="
                        https://salient.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Favatar-1.c78616b7.png&amp;w=64&amp;q=75  1x,
                        https://salient.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Favatar-1.c78616b7.png&amp;w=128&amp;q=75 2x
                      "
                ...
                >
                  ...
                  <div class="overflow-hidden rounded-full bg-slate-50">
                    <img
                      alt=""
                      srcset="
                        https://salient.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Favatar-5.e7f7faf2.png&amp;w=64&amp;q=75  1x,
                        https://salient.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Favatar-5.e7f7faf2.png&amp;w=128&amp;q=75 2x
                      "
                ...
                >
                  ...
                  <div class="overflow-hidden rounded-full bg-slate-50">
                    <img
                      alt=""
                      srcset="
                        https://salient.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Favatar-2.c72e5a40.png&amp;w=64&amp;q=75  1x,
                        https://salient.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Favatar-2.c72e5a40.png&amp;w=128&amp;q=75 2x
                      "
