...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-B4MwtkEu.mjs')
  },
  {
    name: "signin",
    path: "/signin",
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/UFm6l4Zn"}/${locale}/messages.json`, { headers });
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/UFm6l4Zn"}/${locale}/messages.json`));
